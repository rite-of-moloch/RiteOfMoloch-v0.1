...
Configure gnosis arpc url as an environment variable variable. <br>
Example: <br>
```
export gnosis_rpc="https://poa-xdai-archival.gateway.pokt.network/v1/lb/-----Key------"
```
...
<img alt="Compilation benchmarks" src="https://raw.githubusercontent.com/foundry-rs/foundry/master/.github/compilation-benchmark.png" width="693px" />
